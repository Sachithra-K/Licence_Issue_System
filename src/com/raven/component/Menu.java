...
import javax.swing.JOptionPane; // Import JOptionPane for confirmation dialog
...
public class Menu extends javax.swing.JPanel {
   ...
   private EventMenu event;
    ...
    public Menu() {
     ...
     public void initMenu(EventMenu event) {
        ...
        addMenu(new ImageIcon(getClass().getResource("/com/raven/icon/2.png")), "System", 1);
        addMenu(new ImageIcon(getClass().getResource("/com/raven/icon/3.png")), "Edit", 2);
        addMenu(new ImageIcon(getClass().getResource("/com/raven/icon/4.png")), "Search", 3);
        addMenu(new ImageIcon(getClass().getResource("/com/raven/icon/5.png")), "Report", 4);
   ...
   private void addMenu(Icon icon, String text, int index) {
    ...
    private void addLogoutMenu() {
        ImageIcon logoutIcon = new ImageIcon(getClass().getResource("/com/raven/icon/logout.png"));
        ButtonMenu logoutButton = new ButtonMenu();
        ...
        logoutButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (choice == JOptionPane.YES_OPTION) {
                    ...
                    // For example, you can clear user session data, close any open windows, etc.
    ...
    private void initComponents() {
        ...
        imageAvatar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/500_F_94623160_dZ4bhMwsTrl6BTlxKv4JTTUKaRjwiw7C-removebg-preview.png"))); // NOI18N

        jLabel1.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(224, 224, 224));
        jLabel1.setText("Udayangani");
